  ...
  \renewcommand\printchaptertitle[1]{
    ...
    \else
	    \begin{tabularx}{\textwidth}{l X}
	    	\raisebox{-15pt}{\chapnumfont \thechapter} & {\parbox[b]{\linewidth}{\chaptitlefont ##1}}
	    \end{tabularx}
	    \par\vskip2mm\hrule
    \fi
  }
...
\makeoddhead{ASE}{ITSMAP-01 Group 12}{}{ASE - Aarhus University}
\makeevenhead{ASE}{ITSMAP-01 Group 12}{}{ASE - Aarhus University}
